    ...
    if(tipo!=''){
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById('idLin[0]').value=data[4];
                document.getElementById('idCab[0]').value=data[5];
...
function novaLinha(){
        ...
        console.log("antes de nova linha"+j);
        i=document.getElementById('idLin['+j+']').value;
        i++;
        j++;

        cell1.innerHTML = "<input class='form-control' type='text' name='idLin[]' id='idLin["+j+"]' form='form_docFiscais' value='"+ i +"' readonly></input>";
        cell2.innerHTML = "<input class='form-control' type='text' name='idCab[]' id='idCab["+j+"]' form='form_docFiscais' value='"+document.getElementById(`idDocFisc`).value+"' readonly></input>";
        ...
        console.log("depois de nova linha"+j);
};
  ...
  function cancelarTipo(){
    ...
    document.getElementById('idDocFisc').value="";
        ...
        for(var t=0; t <= j ;t++){
            ...
            document.getElementById('idLin['+t+']').value="";
            document.getElementById('idCab['+t+']').value="";
            document.getElementById('refProdLin['+t+']').value="";
            document.getElementById('descProdLin['+t+']').value="";
            document.getElementById('precUni['+t+']').value="";
