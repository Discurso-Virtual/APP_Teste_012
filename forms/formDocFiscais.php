                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table class="table" id="linTable">
                                ...
                                <tr>
                                    <td>
                                        <input class="form-control" type="text" name="idLin[]" id="idLin[0]" form="form_docFiscais" value=""readonly  ></input>
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" name="idCab[]" id="idCab[0]" form="form_docFiscais" value="" readonly ></input>
                                    </td>
                                    <td>
